 ...
 * is written in C++.
 */
public final class ChineseContactListIndexer extends DataSetObserver implements SectionIndexer {
    private static String TAG = "ChineseContactListIndexer";
    ...
    public ChineseContactListIndexer(Cursor cursor, int columnIndex) {
